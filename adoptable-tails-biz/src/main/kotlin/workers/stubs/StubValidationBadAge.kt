...
fun CorChainDsl<AdoptableTailsContext>.stubValidationBadAge(title: String) = worker {
    this.title = title
    on { state == AdoptableTailsState.RUNNING && stub == PetAdStubs.BAD_AGE }
    handle {
